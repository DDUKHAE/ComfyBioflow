...
The code in this directory is intentionally small and registry-driven so future domains can reuse the same parser, planner, node catalog, and workflow builder.
